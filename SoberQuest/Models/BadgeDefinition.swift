...
struct BadgeDefinition: Identifiable, Codable {
    ...
    static let defaultBadges: [BadgeDefinition] = [
        ...
        BadgeDefinition(id: "day210", name: "Elven Spring", milestoneDays: 210, imageAssetName: "badge_day210", rarityLevel: "mythic", description: "210 days of renewal! The Elven Spring flows with the essence of rebirth, a wellspring of endless vitality and hope."),
